    ...
    <Box>
      ...
      <FormControl sx={{mt: '40px'}} error={signUpError} fullWidth variant="standard">
        ...
        />
        {
          ...
          telNumberValidate === null ? (<FormHelperText sx={{ color: 'orange' }}>전화번호 중복체크를 해주세요.</FormHelperText>) :
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', mt: '24px' }}>
        ...
        <Typography sx={{mr: '4px', color: 'black', fontWeight: 400}}>개인정보동의</Typography>
      ...
      <Box>
        {page === 1 && (
          <Button
            ...
            variant="contained"
            size="large"
            sx={{ mb: "20px", backgroundColor: "#FF5500", ":hover": { backgroundColor: "#FF5500" }}}
