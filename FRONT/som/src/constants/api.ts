...
export const GET_TOP12_LIST_URL = `${HOST}api/board/top12-list`;
export const GET_TOP30_SEARCH_WORD_URL = `${HOST}api/board/top30-search-word`;
export const GET_TOP30_RELATED_SEARCH_WORD_URL = (content: string) => `${HOST}api/board/top30-related-search-word/${content}`;
...
export const HATE_URL = `${HOST}api/board/hate`; 
...
export const GET_CATE_LIST_URL = (category: string) => `${HOST}api/board/categories/${category}`
